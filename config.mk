...
CONFIG_INCLUDE_DSP_MANAGMENT = YES AS_SPEED_CRITICAL
...
CONFIG_INCLUDE_VOICE_3D = YES AS_SPEED_CRITICAL
CONFIG_INCLUDE_MEMORY_POOL = YES AS_SPEED_CRITICAL
CONFIG_INCLUDE_VIRTUAL_BASS = YES AS_SPEED_CRITICAL
...
CONFIG_USE_COMPILER 					= ARM-NONE-EABI-GCC#{GCC-HOST,GCC-AVR,ARM-NONE-EABI-GCC,ARM-NONE-EABI-G++,ARMCC,CXSTM8}
...
CONFIG_OPTIMIZE_LEVEL 					= Og#{O0,O1,O2,O3,Og,Os}
